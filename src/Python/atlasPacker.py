...
# Description:
# This program takes png files with their respective .fnt files as generated by bmfont (http://www.angelcode.com/products/bmfont/)
# and places multiple fonts (or sizes) onto the same texture atlas while offsetting the .fnt file data.
